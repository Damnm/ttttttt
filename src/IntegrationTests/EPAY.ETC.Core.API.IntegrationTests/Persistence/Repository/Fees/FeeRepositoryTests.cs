...
namespace EPAY.ETC.Core.API.IntegrationTests.Persistence.Repository.Fees
{
    ...
    public class FeeRepositoryTests : IntegrationTestBase
    {
        ...
        public FeeModel fee = new FeeModel()
        {
            ...
            CreatedDate = new DateTime(2023, 9, 11).ConvertToAsianTime(),
            Amount = 15000,
            ...
            LaneInId = "0301",
            LaneInDate = new DateTime(2023, 9, 14, 1, 0, 24).ConvertToAsianTime(),
            LaneInEpoch = 1694649600,
            LaneOutId = "0302",
            LaneOutDate = new DateTime(2023, 9, 14, 1, 13, 32).ConvertToAsianTime(DateTimeKind.Utc),
